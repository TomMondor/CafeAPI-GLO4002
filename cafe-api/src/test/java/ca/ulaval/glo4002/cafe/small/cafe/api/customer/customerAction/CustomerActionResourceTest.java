package ca.ulaval.glo4002.cafe.small.cafe.api.customer.customerAction;
...
public class CustomerActionResourceTest {
    ...
    private CustomerActionResource customerResource;
    private CustomerService customerService;

    @BeforeEach
    public void createCustomerResource() {
        customerService = mock(CustomerService.class);
        customerResource = new CustomerActionResource(customerService);
    }
